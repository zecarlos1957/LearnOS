...
int _main() {
	...
	BOOT_OPTION(_vboxpointer, 0/*1*/, "VirtualBox Pointer",
			"(Requires Guest Additions) Enables support for the",
			"VirtualBox hardware pointer mapping.");

	BOOT_OPTION(_vmware,    0/*1*/, "VMWare driver",
	...
	BOOT_OPTION(_sound,    0/*1*/, "Audio drivers",
			"Enable the audio subsystem and AC'97 drivers.",
			NULL);

	BOOT_OPTION(_net,      0/*1*/, "Network drivers",
