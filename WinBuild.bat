...
rem goto floppy    
cd ../bin
    ld -T../kernel/link.ld -o krnl32.exe entry.o gdt.o interrupt.o process.o isr.o cpu.o common.o descriptor_tables.o fs.o initrd.o kheap.o main.o monitor.o ordered_array.o paging.o task.o timer.o syscall.o
