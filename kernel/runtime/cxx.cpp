...
extern "C"
{
	...
	int32_t __cxa_atexit(void (*Destructor) (void *), void *Parameter, void *HomeDSO);
...
{
	__extension__ typedef int32_t __guard __attribute__((mode(__DI__)));

	extern "C"
	{
		int32_t __cxa_guard_acquire(__guard *Guard)		{ return ! *(char *) (Guard); }
