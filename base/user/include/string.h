...
extern void * __attribute__ ((malloc)) realloc(void * ptr, size_t size);
extern void * __attribute__ ((malloc)) calloc(size_t nmemb, size_t size);
extern void * __attribute__ ((malloc)) valloc(size_t size);
